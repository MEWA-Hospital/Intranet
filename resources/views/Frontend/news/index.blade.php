                                ...
                                <div class="card border-left-3 border-left-green-300 rounded-left-0">
                                    ...
                                    <div class="card-body">
                                        <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
                                            <div>
                                                <h6><a href="{{ route('frontend.news.show', $article->id) }}">{{ $article->title }}</a></h6>
                                                <p class="mb-3"> {!! str_limit($article->body, 120) !!}</p>
                                    ...
                                    <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
                                        <span>Date: <span
                                                    class="font-weight-semibold">{{ $article->created_at }} </span></span>

                                        <ul class="list-inline mb-0 mt-2 mt-sm-0">
                                            <li class="list-inline-item dropdown">
                                                <span class="text-muted">{{ $article->department->name }}</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
