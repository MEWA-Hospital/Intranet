        ...
        <div class="col-md-9">
            <div class="w-100 overflow-auto order-2 order-md-1">
                ...
                <div class="card">
                    ...
                    <div class="media card-body flex-column flex-md-row m-0">
                        ...
                        <div class="media-body">
                            ...
                            <p>So slit more darn hey well wore submissive savage this shark aardvark fumed thoughtfully
                                much drank when angelfish so outgrew some alas vigorously therefore warthog superb less
                                oh groundhog less alas gibbered barked some hey despicably with aesthetic hamster jay by
                                luckily</p>
                ...
                <div class="card">
                    ...
                    <form class="card-body" action="{{ route('frontend.news.comment', $news->id) }}" method="post">
                        @csrf
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn bg-blue"><i class="icon-plus22 mr-1"></i> Add comment
                            </button>
                        </div>
                    </form>
                </div>
