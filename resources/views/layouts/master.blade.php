									...
									<div class="col-md-2">
										...
										<div class="dropdown-item-group mb-3 mb-md-0">
											<ul class="list-unstyled">
												<li><a href="#" class="dropdown-item rounded">Standard Operating Procedure</a></li>
	...
	<div class="page-header">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Starters</span> - Navbar Secondary Sticky</h4>
