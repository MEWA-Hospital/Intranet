...
use Domain\Department\Models\Bank;
use Domain\Department\Models\BankBranch;
use Domain\Department\Models\Employee;
use Domain\User\Models\User;

class CreateEmployeeAction
{
    public function __invoke(EmployeeData $employeeData): void
    {
        Employee::create([
            'user_id'          => User::find($employeeData->user_id) ?: null,
            'bank_id'          => Bank::find($employeeData->bank_id) ?: null,
            'bank_branch_id'   => BankBranch::find($employeeData->bank_branch_id) ?: null,
